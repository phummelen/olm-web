...
class AddCustomTagsToPhotoTest extends TestCase
{
    ...
    {
        yield ['tags' => ['tag1', 'Tag1'], 'errors' => ['custom_tags.0', 'custom_tags.1']];
        // uniqueness
        yield ['tags' => ['ta'], 'errors' => ['custom_tags.0']];
        // min length 3
        yield ['tags' => [str_repeat('a', 101)], 'errors' => ['custom_tags.0']];
        // max length 100
        yield ['tags' => ['tag1', 'tag2', 'tag3', 'tag4'], 'errors' => ['custom_tags']];
    }
