...
class UpdateTotalPhotosForLocationActionTest extends TestCase
{
    public function test_it_increments_a_redis_hash_for_each_location()
    {
        ...
        $this->assertSame(2 * $increment, Redis::hget("country:$countryId", UpdateTotalPhotosForLocationAction::KEY));
        $this->assertSame(2 * $increment, Redis::hget("state:$stateId", UpdateTotalPhotosForLocationAction::KEY));
        $this->assertSame(2 * $increment, Redis::hget("city:$cityId", UpdateTotalPhotosForLocationAction::KEY));
    }
